rm fifo.cu8 mkfifo fifo.cu8 rm FSK.ft mkfifo FSK.ft
...
#../rtlomniv2 -i fifo.cu8 -m tx -a 1f108958 -p 8 -n 1 -l 42335 -t 650610 
../rtlomniv2 -i fifo.cu8 -m tx -a 1f108958 -p 0 -n 0 -l 43262 -t 580058
